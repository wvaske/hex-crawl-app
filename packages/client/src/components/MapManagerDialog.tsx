...
function Row({
  ...
  return (
    <div className="flex items-center gap-2 py-1">
      <span
        className="w-40 shrink-0 text-[11px] uppercase tracking-wider text-ink-400"
        title={hint}
      >
        {label}
      </span>
...
function DefaultRow({
  ...
  return (
    <div className="flex items-center gap-2 py-1">
      <span className="w-40 shrink-0 text-[11px] uppercase tracking-wider text-ink-400">
        {label}
      </span>
      <div className="flex-1 min-w-0">{children}</div>
      <span
        className="w-16 shrink-0 text-right text-[10px] text-ink-500"
